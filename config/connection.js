...
import { hashed } from "../helpers/authFunctions.js";

export const connectDB = async () => {
    try {
        mongoose.set("strictQuery", false)
        // const conn = await mongoose.connect("mongodb://farshbaf_shop:Mehdi14439@localhost:27017/farshbaf_shop", {
        const conn = await mongoose.connect(process.env.NODE_ENV === "development" ? process.env.MONGO_URI : `mongodb://${process.env.DATABASE_NAME_SERVER}:Mehdi14439@localhost:27017/${process.env.DATABASE_NAME_SERVER}`, {
